import os
import sys
sys.path.append(os.path.abspath('/workspace/PD_SSL_ZOO/3_RECONSTRUCTION/0_GENERATION/2_WDDAE'))
...
parser = argparse.ArgumentParser(description='WDDAE unconditional PET scans generation')
...
parser.add_argument('--log_dir', default='/workspace/PD_SSL_ZOO/3_RECONSTRUCTION/0_GENERATION/2_WDDAE/results')
parser.add_argument('--img_save_dir', default='/workspace/PD_SSL_ZOO/3_RECONSTRUCTION/0_GENERATION/2_WDDAE/results')
