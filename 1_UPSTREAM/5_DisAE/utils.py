...
def save_checkpoint(args, epoch, model, max_accuracy, optimizer, lr_scheduler, logger, best_model=False):
    ...
    if best_model:
        ...
        torch.save(save_state,  f"/workspace/Ablation/ABLATION_PD/DDAE_SSL/output/ckpt_best.pth")
        logger.info(f"{save_path} saving......")

    save_path = os.path.join(args.output, f"ckpt_{epoch}.pth")
    torch.save(save_state,  f"/workspace/Ablation/ABLATION_PD/DDAE_SSL/output/ckpt_epoch_{epoch}.pth")
