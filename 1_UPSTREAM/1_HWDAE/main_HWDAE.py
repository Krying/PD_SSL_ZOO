...
from trainer_HWDAE import run_ddpm_oriAE_training_ddpm
...
parser.add_argument('--wavelet', default=1, type=int)
...
def main_worker_enc(args):
    ...
    lr_scheduler = CosineAnnealingWarmUpRestarts(optimizer, T_0=300, T_mult=2, eta_max=3e-5,  T_up=1, gamma=0.6)

    accuracy = run_ddpm_oriAE_training_ddpm(model,
