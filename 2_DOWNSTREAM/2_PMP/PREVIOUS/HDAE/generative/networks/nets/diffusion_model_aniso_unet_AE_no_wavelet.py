...
__all__ = ["DiffusionModelUNet_aniso_AE_no_wavelet", "DiffusionModelEncoder_ansio_no_wavelet"]
...
class DiffusionModelUNet_aniso_AE_no_wavelet(nn.Module):
    """
...
class DiffusionModelEncoder_ansio_no_wavelet(nn.Module):
    def __init__(
        self,
        spatial_dims: int,
        in_channels: int,
    ...
    def forward(
        ...
        output_cat = torch.cat((output0, output1, output2, output3, output4, output5), dim=1)
