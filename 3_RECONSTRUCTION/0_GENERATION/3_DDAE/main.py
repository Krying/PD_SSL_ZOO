import os
import sys
sys.path.append(os.path.abspath('/workspace/PD_SSL_ZOO/3_RECONSTRUCTION/0_GENERATION/3_DDAE'))
...
parser = argparse.ArgumentParser(description='DDAE reconstruction')
